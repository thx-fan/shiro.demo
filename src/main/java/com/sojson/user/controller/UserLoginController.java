...
import com.sojson.aop.SystemControllerLog;
...
public class UserLoginController extends BaseController {
     ...
     * @return
     */
    @ApiOperation(value = "提交注册信息", notes = "注册")
    @RequestMapping(value = "subRegister", method = RequestMethod.POST)
    @ResponseBody
    public Map<String, Object> subRegister(@ApiParam(value = "验证码", required = true) @RequestParam(value = "vcode",required = true) String vcode, @ApiParam(value = "用户信息", required = true) @RequestParam(value = "entity",required = true) UUser entity) {
    ...
    @SystemControllerLog(description = "提交登录")
    @ResponseBody
